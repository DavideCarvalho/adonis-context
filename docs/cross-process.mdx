...
The integration lives on the side that already owns the boundary — there is **no `@adonis-agora/context-queue` bridge package to install.** You wire two lines: one where you dispatch, one where you consume.
